...
cv_func <- function(fold){
  ...
  ### setting train control information
...
FoldsTest <- pmclapply(folds, cv_func, mc.cores = 20, mc.silent = FALSE)
...
write_rds(FinalModel, "FittedModels/AnnualCONUSRFModel_cv.rds", compress = "gz")
